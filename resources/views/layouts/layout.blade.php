...
<body class="hold-transition sidebar-mini">
    ...
    <div class="wrapper">
        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            <!-- SEARCH FORM -->
            <form class="form-inline ml-3" method="GET" action="{{ route( Auth::user()->role->tag == 'administrator' ? 'search.admin' : 'search') }}">
                <div class="input-group input-group-sm">
                    <input name="s" class="form-control form-control-navbar" type="search" placeholder="Поиск" aria-label="Search">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="image">
                        {{--<img src="{{ asset('assets/front/img/user2-160x160.jpg') }}" class="img-circle elevation-2"
                        alt="User Image">--}}
                    </div>
                    <div class="info">
                        <a href="{{ route ('personalCabinet') }}" class="d-block">{{ Auth::user()->surname }} {{ Auth::user()->name }}</a>
                    </div>
                </div>
